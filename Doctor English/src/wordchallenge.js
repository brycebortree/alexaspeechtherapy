...
function handleGetHelpRequest(intent, session, callback) {
    ...
    var speechOutput = "To start a new word challenge at any time, say, start new word challenge. "
        + "To repeat the last word, say, repeat. "
        + "Would you like to keep playing?",
        repromptText = "Try again to pronounce them. "
        + "Would you like to keep playing?";
...
function handleFinishSessionRequest(intent, session, callback) {
    ...
    callback(session.attributes,
        buildSpeechletResponseWithoutCard("Thanks for playing Doctor English!", "", true));
}
